import { CardHeader, Flex, Heading, Text } from 'uikitpanswap'
...
export const PoolCardHeaderTitle: React.FC<{ isFinished?: boolean; title: ReactNode; subTitle: ReactNode }> = ({
  ...
  return (
    <Flex flexDirection="column">
      <Heading color={isFinished ? 'textDisabled' : 'contrast'} scale="lg" style={{fontWeight: 'bold', fontSize: '30px', lineHeight: '38px', letterSpacing: '2px'}}>
        {title}
      </Heading>
