...
import { Svg, SvgProps } from 'uikitpanswap'
    ...
    <Svg viewBox="0 0 1660 339" {...props}>
      ...
      <defs>
        <linearGradient id="paint0_linear_dark" x1="830" y1="83.5" x2="830" y2="338.5" gradientUnits="userSpaceOnUse">
          <stop stopColor="#1c2832" stopOpacity="0.2" />
          <stop offset="0.545554" stopColor="#1c2832" stopOpacity="0.5" />
          <stop offset="1" stopColor="#1c2832" />
        </linearGradient>
      </defs>
    </Svg>
  )
